...
function googleUserFormater(profile) {
    ...
    if (profile._json.name && profile._json.name.given_name) {
        user.givenName = profile._json.name.given_name;
    }

    if (profile._json.name && profile._json.name.family_name) {
        user.familyName = profile._json.name.family_name;
    }
